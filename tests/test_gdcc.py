...
def learn():
    for l in ["modelTestA_1", "modelTestB_1"]:
        ...
        infobjects[l] = EMCC(models[l], datasets[l], max_iter=100, num_runs=20)    # todo: cambiar
        causes[l], effects[l] = [models[l].endogenous[i] for i in [0, -1]]


@pytest.mark.parametrize("label,expected",
                             [("modelTestA_1", [0.5783249936269131, 0.27823307599470376, 0.7217669240052962, 0.4216750063730869]), # todo: cambiar por valores parecidos
                              ("modelTestB_1", [0.46011788201489945, 0.5398821179411604, 0.46011788205883963, 0.5398821179851006]) # todo: cambiar por valores parecidos
                              ]
                         )
